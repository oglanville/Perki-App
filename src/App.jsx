...
/* ═══════════════ PERK URLS ═══════════════ */
const PERK_URLS = {
  "ovo-beyond-costa-coffee":"https://www.ovoenergy.com/beyond","ovo-beyond-power-move":"https://www.ovoenergy.com/beyond","ovo-beyond-uber-green":"https://www.ovoenergy.com/beyond","ovo-beyond-vip-tickets":"https://www.ovoenergy.com/beyond","ovo-beyond-boiler-service":"https://www.ovoenergy.com/beyond","ovo-beyond-tesco-clubcard":"https://www.ovoenergy.com/beyond","ovo-beyond-oddbox-discount":"https://www.ovoenergy.com/beyond",
  "monzo-perks-greggs-weekly":"https://monzo.com/monzo-perks","monzo-perks-railcard":"https://monzo.com/monzo-perks","monzo-perks-billsback":"https://monzo.com/monzo-perks","monzo-perks-savings-rate":"https://monzo.com/monzo-perks","monzo-perks-fee-free-withdrawals":"https://monzo.com/monzo-perks","monzo-max-travel-insurance":"https://monzo.com/monzo-perks","monzo-max-phone-insurance":"https://monzo.com/monzo-perks","monzo-max-breakdown-cover":"https://monzo.com/monzo-perks",
  "revolut-premium-travel-insurance":"https://www.revolut.com/en-GB/premium","revolut-premium-atm-withdrawals":"https://www.revolut.com/en-GB/premium","revolut-premium-currency-exchange":"https://www.revolut.com/en-GB/premium","revolut-metal-atm-800":"https://www.revolut.com/en-GB/metal","revolut-metal-travel-insurance":"https://www.revolut.com/en-GB/metal","revolut-metal-revpoints":"https://www.revolut.com/en-GB/metal","revolut-metal-savings":"https://www.revolut.com/en-GB/metal","revolut-ultra-lounge-access":"https://www.revolut.com/en-GB/ultra","revolut-ultra-partner-subs":"https://www.revolut.com/en-GB/ultra","revolut-ultra-atm-2000":"https://www.revolut.com/en-GB/ultra","revolut-ultra-savings":"https://www.revolut.com/en-GB/ultra","revolut-ultra-revpoints-1per1":"https://www.revolut.com/en-GB/ultra",
  "amex-gold-airport-lounge":"https://www.americanexpress.com/uk/credit-cards/gold-card/","amex-gold-deliveroo-credit":"https://www.americanexpress.com/uk/credit-cards/gold-card/","amex-gold-hotel-collection":"https://www.americanexpress.com/uk/credit-cards/gold-card/","amex-gold-double-airline-points":"https://www.americanexpress.com/uk/credit-cards/gold-card/",
  "amex-plat-airport-lounge-1":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-dining-credit-uk":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-dining-credit-intl":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-hotel-status":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-eurostar-lounge":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-times-digital":"https://www.americanexpress.com/uk/credit-cards/platinum-card/","amex-plat-car-hire-status":"https://www.americanexpress.com/uk/credit-cards/platinum-card/",
};
...
/* ═══════════════ COLLAPSIBLE PROVIDER GROUP (Changes #4/#5) ═══════════════ */
function CollapsibleProviderGroup({provider,tier,perkCount,price,defaultOpen=true,headerRight,children}){
  const[open,setOpen]=useState(defaultOpen);
  const pCfg=PROVIDERS[provider]||{color:T.muted,bg:"#F1F5F9"};
  return(
    <div style={{marginBottom:14}}>
      <div onClick={()=>setOpen(!open)} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 12px",borderRadius:open?"12px 12px 0 0":12,background:pCfg.bg||"#F1F5F9",border:`1.5px solid ${pCfg.color||T.border}33`,borderBottom:open?`1.5px dashed ${pCfg.color||T.border}44`:`1.5px solid ${pCfg.color||T.border}33`,cursor:"pointer",transition:"all 0.15s"}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <ProviderBadge provider={provider} size={28}/>
          <div>
            <div style={{fontSize:13,fontWeight:700,color:T.textPrimary,fontFamily:"'DM Sans',sans-serif"}}>{provider}{tier?` — ${tier}`:""}</div>
            <div style={{fontSize:10,color:T.textSecondary,fontFamily:"'DM Sans',sans-serif"}}>{perkCount} perk{perkCount!==1?"s":""}{price&&<span style={{marginLeft:6,fontWeight:700,color:pCfg.color||T.accent}}> · {price}</span>}</div>
          </div>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:6}}>
          {headerRight}
          <span style={{fontSize:14,color:T.muted,transform:open?"rotate(180deg)":"rotate(0deg)",display:"inline-block",transition:"transform 0.2s"}}>▾</span>
        </div>
      </div>
      {open&&(<div style={{padding:"8px 10px 10px",borderRadius:"0 0 12px 12px",background:`${pCfg.bg||"#F1F5F9"}66`,border:`1.5px solid ${pCfg.color||T.border}22`,borderTop:"none"}}>{children}</div>)}
    </div>
  );
}

/* ── PerkTooltip with readOnly support ── */
function PerkTooltip({perk,onToggle,onDismiss,readOnly}){
  ...
  return(
    <div onClick={e=>e.stopPropagation()} style={{padding:"14px 14px 14px 18px",borderRadius:12,background:T.surface,color:T.textPrimary,fontSize:12,lineHeight:1.5,fontFamily:"'DM Sans',sans-serif",boxShadow:"0 2px 10px rgba(15,23,42,0.08)",zIndex:10,border:`1px solid ${T.border}`,borderLeft:`4px solid ${pCfg.color||T.accent}`,position:"relative"}}>
      ...
      <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:readOnly?0:10,fontSize:11,color:T.muted}}>
        <span>📅 {perk.next_reset_date?`Renews ${perk.next_reset_date}`:"No renewal date"}</span>
        <span>🔄 {resetLabel(perk.reset_period)}</span>
      </div>
      {!readOnly&&(<div style={{display:"flex",flexDirection:"column",gap:8}}>
...
/* ── PerkTile with readOnly ── */
function PerkTile({perk,onToggle,onDismiss,selected,onSelect,readOnly}){
  const pCfg=PROVIDERS[perk.provider]||{};const isDimmed=perk.used||perk.dismissed;
  return(<div style={{position:"relative"}}>
    ...
    {perk.perk_id===selected&&<div style={{margin:"4px 0 6px"}}><PerkTooltip perk={perk} onToggle={onToggle} onDismiss={onDismiss} readOnly={readOnly}/></div>}
  </div>);
}

/* ── PotentialPerkTile ── */
function PotentialPerkTile({perk,selected,onSelect}){
  const pCfg=PROVIDERS[perk.provider]||{};const url=PERK_URLS[perk.perk_id];const perkCallout=perk.perk_id===selected;
  return(<div style={{position:"relative"}}>
...
/* ── PerkCalloutModal with readOnly ── */
function PerkCalloutModal({perk,onToggle,onDismiss,onClose,readOnly}){
  const pCfg=PROVIDERS[perk.provider]||{color:T.accent};const b=PERK_BRANDS[perk.perk_id]||{emoji:"📦",gradient:`linear-gradient(135deg,${T.muted},${T.border})`};
  return(<div onClick={onClose} style={{position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
    <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:360,background:T.surface,borderRadius:16,overflow:"hidden",boxShadow:"0 20px 60px rgba(0,0,0,0.25)",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      <div style={{background:"#1E293B",padding:"20px 18px 16px",display:"flex",alignItems:"center",gap:12,position:"relative"}}>
        ...
        <div><div style={{fontSize:15,fontWeight:800,color:"#fff"}}>{perk.title}</div><div style={{fontSize:11,fontWeight:600,color:"rgba(255,255,255,0.8)",marginTop:2}}>{perk.membership} — {perk.tier}</div></div>
      </div>
      <div style={{padding:"16px 18px 18px",borderLeft:`4px solid ${pCfg.color||T.accent}`}}>
        ...
        <div style={{display:"flex",gap:12,flexWrap:"wrap",marginBottom:readOnly?0:14,fontSize:11,color:T.muted}}>
          <span>📅 {perk.next_reset_date?`Renews ${perk.next_reset_date}`:"No renewal date"}</span><span>🔄 {resetLabel(perk.reset_period)}</span>
        </div>
        {!readOnly&&(<div style={{display:"flex",flexDirection:"column",gap:10}}>
          <label style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",fontSize:13,fontWeight:600,color:T.textPrimary}}><input type="checkbox" checked={!!perk.used} onChange={()=>onToggle(perk.perk_id)} disabled={!!perk.dismissed} style={{width:18,height:18,accentColor:T.success,cursor:"pointer"}}/>{perk.used?"Marked as used":"Mark as used"}</label>
          <label style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",fontSize:13,fontWeight:600,color:perk.dismissed?T.danger:T.muted}}><input type="checkbox" checked={!!perk.dismissed} onChange={()=>onDismiss(perk.perk_id)} style={{width:18,height:18,accentColor:T.danger,cursor:"pointer"}}/>Will not use (exclude from count)</label>
        </div>)}
        {readOnly&&<div style={{marginTop:10,fontSize:11,fontWeight:600,color:T.muted,fontStyle:"italic",fontFamily:"'DM Sans',sans-serif"}}>Sign in to track and manage this perk.</div>}
      </div>
    </div>
  </div>);
}

/* ── PerkSquareTile with readOnly ── */
function PerkSquareTile({perk,onToggle,onDismiss,selected,onSelect,readOnly}){
  const b=PERK_BRANDS[perk.perk_id]||{emoji:"📦",gradient:`linear-gradient(135deg,${T.muted},${T.border})`,initials:"??"};const pCfg=PROVIDERS[perk.provider]||{color:T.muted,initials:"??"};const isDimmed=perk.used||perk.dismissed;const isSel=perk.perk_id===selected;
  return(<div style={{position:"relative"}}>
    <div onClick={e=>{e.stopPropagation();onSelect(isSel?null:perk.perk_id);}} style={{width:"100%",aspectRatio:"1",borderRadius:14,overflow:"hidden",cursor:"pointer",background:b.gradient,position:"relative",transition:"all 0.15s",opacity:isDimmed?0.45:1,border:`2px solid ${isSel?T.accent:"transparent"}`,boxShadow:isSel?"0 0 0 2px rgba(30,144,255,0.3)":isDimmed?"none":"0 2px 8px rgba(0,0,0,0.1)"}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"rgba(0,0,0,0.55)",backdropFilter:"blur(4px)",padding:"6px 8px"}}><div style={{fontSize:10,fontWeight:700,color:"#fff",fontFamily:"'DM Sans',sans-serif",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",lineHeight:1.3}}>{perk.title}</div></div>
    </div>
    {isSel&&<PerkCalloutModal perk={perk} onToggle={onToggle} onDismiss={onDismiss} onClose={()=>onSelect(null)} readOnly={readOnly}/>}
  </div>);
}
...
function HowToUseModal({onClose}){
  return(<div onClick={onClose} style={{position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
    <div onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:380,maxHeight:"80vh",overflowY:"auto",background:"#1E293B",borderRadius:16,padding:"20px 18px",color:"#CBD5E1",fontSize:12,lineHeight:1.6,fontFamily:"'DM Sans',sans-serif",boxShadow:"0 20px 60px rgba(0,0,0,0.3)",position:"relative"}}>
      ...
      <div style={{fontWeight:700,color:"#fff",marginBottom:4}}>💳 Current Memberships</div><div style={{marginBottom:12}}>Browse perks grouped by provider. Tap a provider to collapse or expand.</div>
      ...
      <div style={{fontWeight:700,color:"#fff",marginBottom:4}}>✨ Potential Memberships</div><div style={{marginBottom:12}}>Discover memberships you don't have yet. Tap "+ Add Tier" to add an entire provider and tier. Use + to request one we haven't listed.</div>
      <div style={{fontWeight:700,color:"#fff",marginBottom:4}}>👤 Profile</div><div>View stats, manage active memberships (tap to expand, "Remove" to delete), and update your profile picture.</div>
    </div>
  </div>);
}

/* ═══════════════ SIGN-IN CALLOUT (Change #1) ═══════════════ */
function SignInCallout({onSignIn,onDismiss}){
  return(<div style={{position:"fixed",inset:0,zIndex:300,background:"rgba(15,23,42,0.6)",backdropFilter:"blur(4px)",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
    <div style={{width:"100%",maxWidth:340,background:T.surface,borderRadius:18,overflow:"hidden",boxShadow:"0 24px 64px rgba(0,0,0,0.3)",fontFamily:"'DM Sans',sans-serif",textAlign:"center"}}>
      <div style={{background:"linear-gradient(135deg,#1E90FF,#0B3D91)",padding:"28px 24px 20px"}}>
        <div style={{width:52,height:52,borderRadius:14,margin:"0 auto 12px",background:"rgba(255,255,255,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,fontWeight:900,color:"#fff",border:"2px solid rgba(255,255,255,0.3)"}}>P</div>
        <div style={{fontSize:20,fontWeight:800,color:"#fff",marginBottom:4}}>Welcome to Perki</div>
        <div style={{fontSize:13,color:"rgba(255,255,255,0.8)",fontWeight:500}}>All your membership perks in one place</div>
      </div>
      <div style={{padding:"20px 24px 24px"}}>
        <p style={{fontSize:13,color:T.textSecondary,margin:"0 0 18px",lineHeight:1.6}}>Sign in to track your perks, mark them as used, and manage your memberships.</p>
        <button onClick={onSignIn} style={{width:"100%",padding:"13px 0",borderRadius:12,border:"none",background:`linear-gradient(135deg,${T.accent},${T.primary})`,color:"#fff",fontSize:15,fontWeight:800,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",boxShadow:"0 4px 14px rgba(30,144,255,0.3)",marginBottom:10}}>Sign In / Sign Up</button>
        <button onClick={onDismiss} style={{width:"100%",padding:"11px 0",borderRadius:12,border:`1.5px solid ${T.border}`,background:T.bg,color:T.textSecondary,fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"'DM Sans',sans-serif"}}>Continue as Preview</button>
      </div>
    </div>
  </div>);
}
...
function PreviewBlurOverlay({message,onSignIn}){
  return(<div style={{position:"relative"}}>
    <div style={{filter:"blur(6px)",pointerEvents:"none",userSelect:"none",opacity:0.5}}>
      <div style={{padding:"20px 0"}}><div style={{height:60,borderRadius:14,background:T.border,marginBottom:12}}/><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>{[1,2,3,4,5,6].map(i=><div key={i} style={{aspectRatio:"1",borderRadius:14,background:`linear-gradient(135deg,${T.border},${T.muted}44)`}}/>)}</div></div>
    </div>
    <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",zIndex:10}}>
      <div style={{background:"rgba(255,255,255,0.95)",backdropFilter:"blur(8px)",borderRadius:16,padding:"24px 28px",textAlign:"center",boxShadow:"0 8px 32px rgba(15,23,42,0.12)",border:`1px solid ${T.border}`,maxWidth:280}}>
        <div style={{fontSize:28,marginBottom:8}}>🔒</div>
        <div style={{fontSize:14,fontWeight:700,color:T.textPrimary,marginBottom:6,fontFamily:"'DM Sans',sans-serif"}}>{message}</div>
        <div style={{fontSize:12,color:T.textSecondary,marginBottom:14,fontFamily:"'DM Sans',sans-serif"}}>Sign in to access your personal data.</div>
        <button onClick={onSignIn} style={{padding:"10px 24px",borderRadius:10,border:"none",background:`linear-gradient(135deg,${T.accent},${T.primary})`,color:"#fff",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",boxShadow:"0 3px 10px rgba(30,144,255,0.3)"}}>Sign In</button>
      </div>
    </div>
  </div>);
}
...
/* ═══════════════ HOME TAB ═══════════════ */
function HomeTab({perks,onToggle,onDismiss,previewMode,onSignIn}){
  const[selected,setSelected]=useState(null);const[groupBy,setGroupBy]=useState("reset");const[showHelp,setShowHelp]=useState(false);
  const sorted=useMemo(()=>[...perks].sort(alphaSort),[perks]);const countable=perks.filter(p=>!p.dismissed);const used=countable.filter(p=>p.used).length;
  const groups=useMemo(()=>{if(groupBy==="category"){const g={};sorted.forEach(p=>{const c=CATEGORIES[p.category]?.label||"Other";(g[c]=g[c]||[]).push(p);});return g;}const g={Weekly:[],Monthly:[],Annually:[],"Always On":[]};sorted.forEach(p=>{g[{WEEKLY:"Weekly",MONTHLY:"Monthly",ANNUALLY:"Annually",NONE:"Always On"}[p.reset_period]||"Always On"].push(p);});return g;},[sorted,groupBy]);
  ...
  if(previewMode){return(<div>
    ...
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:2}}>
      ...
      <button onClick={e=>{e.stopPropagation();setShowHelp(true);}} style={{padding:"6px 12px",borderRadius:10,border:`1.5px solid ${T.border}`,background:T.surface,color:T.textSecondary,fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",boxShadow:T.shadow,position:"relative",zIndex:20}}>📖 How to use</button>
    </div>
    <TabDesc>Tap any perk to see details, mark it as used, or exclude it from your count.</TabDesc>
    <PreviewBlurOverlay message="Sign in to see your perks" onSignIn={onSignIn}/>
  </div>);}
  ...
  return(<div onClick={()=>setSelected(null)}>
    ...
    {Object.entries(groups).map(([name,items])=>items.length>0&&(<div key={name}><SectionHeader count={items.length}>{name}</SectionHeader><div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>{items.map(p=><PerkSquareTile key={p.perk_id} perk={p} onToggle={onToggle} onDismiss={onDismiss} selected={selected} onSelect={setSelected}/>)}</div></div>))}
  </div>);
}

/* ═══════════════ CURRENT MEMBERSHIPS (Change #4: grouped by provider, collapsible) ═══════════════ */
function MembershipsTab({perks,onToggle,onDismiss,activeMemberships,previewMode,onSignIn}){
  const[selected,setSelected]=useState(null);const[search,setSearch]=useState("");
  const filtered=useMemo(()=>{let r=[...perks];if(search.trim()){const q=search.toLowerCase();r=r.filter(p=>p.title.toLowerCase().includes(q)||p.provider.toLowerCase().includes(q));}return r.sort(alphaSort);},[perks,search]);
  const providerGroups=useMemo(()=>{const g={};filtered.forEach(p=>{if(!g[p.provider])g[p.provider]=[];g[p.provider].push(p);});return Object.entries(g).sort((a,b)=>a[0].localeCompare(b[0]));},[filtered]);
  const countable=filtered.filter(p=>!p.dismissed);const used=countable.filter(p=>p.used).length;

  return(<div onClick={()=>setSelected(null)}>
    <h1 style={{fontSize:22,fontWeight:800,color:T.textPrimary,margin:0,fontFamily:"'DM Sans',sans-serif"}}>Current Memberships</h1>
    <TabDesc>Browse perks from your active memberships, grouped by provider.</TabDesc>
    {!previewMode&&<input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search perk name or provider..." style={{width:"100%",padding:"9px 14px",borderRadius:10,border:`1.5px solid ${T.border}`,background:T.surface,fontSize:13,fontFamily:"'DM Sans',sans-serif",color:T.textPrimary,marginBottom:10,boxSizing:"border-box",outline:"none"}}/>}
    {filtered.length>0&&<p style={{fontSize:12,color:T.textSecondary,margin:"0 0 12px",fontFamily:"'DM Sans',sans-serif",fontWeight:600}}>Used {used} / Total {countable.length}</p>}
    {providerGroups.map(([provider,provPerks])=>{
      const tierMap={};provPerks.forEach(p=>{if(!tierMap[p.tier])tierMap[p.tier]=[];tierMap[p.tier].push(p);});const tiers=Object.entries(tierMap);const totalForProvider=provPerks.length;const price=tiers.length===1?TIER_PRICES[`${provider}|${tiers[0][0]}`]:null;
      return(<CollapsibleProviderGroup key={provider} provider={provider} tier={tiers.length===1?tiers[0][0]:null} perkCount={totalForProvider} price={price} defaultOpen={true}>
        {tiers.map(([tierName,tierPerks])=>(<div key={tierName}>
          {tiers.length>1&&(<div style={{fontSize:10,fontWeight:800,color:PROVIDERS[provider]?.color||T.accent,textTransform:"uppercase",letterSpacing:"0.5px",margin:"8px 0 5px",fontFamily:"'DM Sans',sans-serif",display:"flex",alignItems:"center",gap:5}}>
            <span style={{width:5,height:5,borderRadius:3,background:PROVIDERS[provider]?.color||T.accent}}/>{tierName}
            {TIER_PRICES[`${provider}|${tierName}`]&&<span style={{fontSize:9,fontWeight:600,color:T.textSecondary,marginLeft:4}}>({TIER_PRICES[`${provider}|${tierName}`]})</span>}
            <span style={{fontSize:9,fontWeight:700,background:`${PROVIDERS[provider]?.color||T.accent}15`,color:PROVIDERS[provider]?.color||T.accent,padding:"1px 5px",borderRadius:8}}>{tierPerks.length}</span>
          </div>)}
          <div style={{display:"flex",flexDirection:"column",gap:4}}>{tierPerks.map(p=><PerkTile key={p.perk_id} perk={p} onToggle={onToggle} onDismiss={onDismiss} selected={selected} onSelect={setSelected} readOnly={previewMode}/>)}</div>
        </div>))}
...
function ProfileTab({perks,activeMemberships,onRemoveMembership,user,onLogout,onToggle,onDismiss,previewMode,onSignIn}){
  ...
  if(previewMode){return(<div>
    ...
    <PreviewBlurOverlay message="Sign in to view your profile" onSignIn={onSignIn}/>
  </div>);}

  return(<div onClick={()=>setSelectedPerk(null)}><h1 style={{fontSize:22,fontWeight:800,color:T.textPrimary,margin:0,fontFamily:"'DM Sans',sans-serif"}}>Profile</h1><TabDesc>Manage your account, view stats, and control memberships.</TabDesc>
...
/* ═══════════════ POTENTIAL MEMBERSHIPS (Change #2: + icon, #3: Reset comp, #5: collapsible) ═══════════════ */
function PotentialTab({allPerks,activeMemberships,onAddMembership,userName,userId,previewMode}){
  const[brand,setBrand]=useState("");const[tier,setTier]=useState("");const[search,setSearch]=useState("");const[selected,setSelected]=useState(null);const[showReq,setShowReq]=useState(false);const[reqName,setReqName]=useState(userName||"");const[reqText,setReqText]=useState("");const[reqSent,setReqSent]=useState(false);
  ...
  const availBrands=useMemo(()=>[...new Set(allPerks.map(p=>p.provider))].filter(b=>[...new Set(allPerks.filter(p=>p.provider===b).map(p=>p.tier))].some(t=>!activeSet.has(`${b}|${t}`))).sort(),[activeSet,allPerks]);
  const availTiers=useMemo(()=>{if(!brand)return[];return[...new Set(allPerks.filter(p=>p.provider===brand).map(p=>p.tier))].filter(t=>!activeSet.has(`${brand}|${t}`));},[brand,activeSet,allPerks]);
  ...
  const providerTierGroups=useMemo(()=>{const provMap={};filtered.forEach(p=>{if(!provMap[p.provider])provMap[p.provider]={};const k=p.tier;if(!provMap[p.provider][k])provMap[p.provider][k]={provider:p.provider,membership:p.membership,tier:p.tier,perks:[]};provMap[p.provider][k].perks.push(p);});return Object.entries(provMap).sort((a,b)=>a[0].localeCompare(b[0]));},[filtered]);
  ...
  return(<div onClick={()=>setSelected(null)}>
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:2}}>
      ...
      {/* Change #2: Plus icon */}
      {!previewMode&&<button onClick={e=>{e.stopPropagation();setShowReq(!showReq);setReqSent(false);setReqName(userName||"");setReqText("");}} style={{width:32,height:32,borderRadius:16,border:`1.5px solid ${showReq?T.accent:T.border}`,background:showReq?"#EFF6FF":T.surface,color:showReq?T.accent:T.textSecondary,fontSize:18,fontWeight:800,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans',sans-serif",boxShadow:T.shadow}}>+</button>}
    </div>
    <TabDesc>Explore memberships you haven't added. {!previewMode?"Add an entire tier or request one we haven't listed.":"Sign in to add memberships."}</TabDesc>

    {/* Change #3: Reset Competition Entry */}
    <div style={{marginBottom:14,padding:"14px 16px",borderRadius:14,background:"linear-gradient(135deg,#0F172A 0%,#1E293B 100%)",border:"1.5px solid #334155",boxShadow:"0 4px 16px rgba(0,0,0,0.15)"}}>
    ...
    <div style={{display:"flex",gap:8,marginBottom:14}}><Dropdown value={brand} onChange={v=>{setBrand(v);setTier("");}} options={availBrands} placeholder="All Providers"/><Dropdown value={tier} onChange={setTier} options={availTiers} placeholder="All Tiers" disabled={!brand}/></div>

    {/* Change #5: Provider-grouped collapsible sections */}
    {providerTierGroups.map(([provider,tierMap])=>{const allTiers=Object.values(tierMap);const totalPerks=allTiers.reduce((sum,g)=>sum+g.perks.length,0);
      return(<CollapsibleProviderGroup key={provider} provider={provider} tier={null} perkCount={totalPerks} defaultOpen={true}>
        {allTiers.map(g=>(<div key={`${g.provider}|${g.tier}`} style={{marginBottom:8}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6,padding:"8px 10px",borderRadius:10,background:T.surface,border:`1px solid ${PROVIDERS[g.provider]?.color||T.border}22`}}>
            <div><div style={{fontSize:12,fontWeight:700,color:T.textPrimary,fontFamily:"'DM Sans',sans-serif"}}>{g.tier}</div><div style={{fontSize:10,color:T.textSecondary,fontFamily:"'DM Sans',sans-serif"}}>{g.perks.length} perks{TIER_PRICES[`${g.provider}|${g.tier}`]&&<span style={{marginLeft:6,fontWeight:700,color:PROVIDERS[g.provider]?.color||T.accent}}>· {TIER_PRICES[`${g.provider}|${g.tier}`]}</span>}</div></div>
            {!previewMode&&<button onClick={()=>onAddMembership(g.provider,g.membership,g.tier)} style={{padding:"5px 12px",borderRadius:8,border:"none",background:T.accent,color:"#fff",fontSize:10,fontWeight:700,cursor:"pointer",fontFamily:"'DM Sans',sans-serif",boxShadow:"0 2px 6px rgba(30,144,255,0.3)"}}>+ Add Tier</button>}
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:4}}>{g.perks.map(p=><PotentialPerkTile key={p.perk_id} perk={p} selected={selected} onSelect={setSelected}/>)}</div>
        </div>))}
      </CollapsibleProviderGroup>);
    })}
    {providerTierGroups.length===0&&<p style={{textAlign:"center",color:T.muted,marginTop:30,fontSize:13,fontFamily:"'DM Sans',sans-serif"}}>{search?"No matching perks.":"All tiers added."}</p>}
  </div>);
}

/* ═══════════════ MAIN APP ═══════════════ */
export default function PerikiApp(){
  const[user,setUser]=useState(null);const[tab,setTab]=useState("home");const[loading,setLoading]=useState(true);const[allPerks,setAllPerks]=useState([]);const[activeMemberships,setActiveMemberships]=useState([]);const[usedMap,setUsedMap]=useState({});const[dismissedMap,setDismissedMap]=useState({});
  const[previewMode,setPreviewMode]=useState(false);const[showSignInCallout,setShowSignInCallout]=useState(false);

  useEffect(()=>{if(!SB_CONFIGURED){setLoading(false);return;}let resolved=false;const resolve=()=>{if(!resolved){resolved=true;setLoading(false);}};const timeout=setTimeout(()=>{if(!resolved){console.warn("[Perki] Auth timeout");resolve();}},5000);let subscription;try{const result=supabase.auth.onAuthStateChange((event,session)=>{if(session?.user){const meta=session.user.user_metadata||{};setUser({id:session.user.id,name:meta.full_name||session.user.email?.split("@")[0]||"User",email:session.user.email});setPreviewMode(false);supabase.from("profiles").select("full_name").eq("id",session.user.id).single().then(({data})=>{if(data?.full_name)setUser(prev=>prev?.id===session.user.id?{...prev,name:data.full_name}:prev);}).catch(()=>{});}else{setUser(null);}resolve();});subscription=result.data.subscription;}catch(err){resolve();}return()=>{clearTimeout(timeout);subscription?.unsubscribe();};},[]);
  ...
  useEffect(()=>{if(!user?.id){setActiveMemberships([]);setUsedMap({});setDismissedMap({});return;}(async()=>{if(!SB_CONFIGURED){setActiveMemberships([{provider:"OVO Energy",membership:"OVO Energy",tier:"Beyond"},{provider:"Monzo",membership:"Monzo",tier:"Max"},{provider:"Revolut",membership:"Revolut",tier:"Metal"},{provider:"American Express",membership:"American Express",tier:"Platinum"}]);return;}const{data:mData}=await supabase.from("user_memberships").select("provider,membership,tier").eq("user_id",user.id);setActiveMemberships(mData||[]);const{data:sData}=await supabase.from("user_perk_state").select("perk_id,used,dismissed").eq("user_id",user.id);const uMap={},dMap={};(sData||[]).forEach(r=>{if(r.used)uMap[r.perk_id]=true;if(r.dismissed)dMap[r.perk_id]=true;});setUsedMap(uMap);setDismissedMap(dMap);})();},[user?.id]);

  const userPerks=useMemo(()=>{const s=new Set();activeMemberships.forEach(m=>{getEffectiveTiers(m.provider,m.tier).forEach(t=>{allPerks.forEach(p=>{if(p.provider===m.provider&&p.tier===t)s.add(p.perk_id);});});});return allPerks.filter(p=>s.has(p.perk_id)).map(p=>({...p,used:!!usedMap[p.perk_id],dismissed:!!dismissedMap[p.perk_id]}));},[activeMemberships,allPerks,usedMap,dismissedMap]);
  ...
  const toggleUsed=useCallback(async(perkId)=>{if(previewMode)return;const newVal=!usedMap[perkId];setUsedMap(prev=>({...prev,[perkId]:newVal}));if(SB_CONFIGURED&&user?.id)await supabase.from("user_perk_state").upsert({user_id:user.id,perk_id:perkId,used:newVal,used_at:newVal?new Date().toISOString():null,updated_at:new Date().toISOString(),dismissed:!!dismissedMap[perkId]},{onConflict:"user_id,perk_id"});},[usedMap,dismissedMap,user?.id,previewMode]);
  const toggleDismissed=useCallback(async(perkId)=>{if(previewMode)return;const newVal=!dismissedMap[perkId];setDismissedMap(prev=>({...prev,[perkId]:newVal}));if(newVal)setUsedMap(prev=>({...prev,[perkId]:false}));if(SB_CONFIGURED&&user?.id)await supabase.from("user_perk_state").upsert({user_id:user.id,perk_id:perkId,dismissed:newVal,used:newVal?false:!!usedMap[perkId],updated_at:new Date().toISOString()},{onConflict:"user_id,perk_id"});},[dismissedMap,usedMap,user?.id,previewMode]);
  const addMembership=useCallback(async(provider,membership,tier)=>{if(previewMode)return;setActiveMemberships(prev=>{if(HIERARCHICAL_PROVIDERS.has(provider)){const c=TIER_HIERARCHY[provider]||[];const ni=c.indexOf(tier);return[...prev.filter(m=>m.provider!==provider||c.indexOf(m.tier)>ni),{provider,membership,tier}];}if(prev.find(m=>m.provider===provider&&m.tier===tier))return prev;return[...prev,{provider,membership,tier}];});if(SB_CONFIGURED&&user?.id){if(HIERARCHICAL_PROVIDERS.has(provider)){const c=TIER_HIERARCHY[provider]||[];const ni=c.indexOf(tier);const lt=c.slice(0,ni);if(lt.length)await supabase.from("user_memberships").delete().eq("user_id",user.id).eq("provider",provider).in("tier",lt);}await supabase.from("user_memberships").upsert({user_id:user.id,provider,membership,tier},{onConflict:"user_id,provider,tier"});}},[user?.id,previewMode]);
  const removeMembership=useCallback(async(provider,tier)=>{if(previewMode)return;setActiveMemberships(prev=>prev.filter(m=>!(m.provider===provider&&m.tier===tier)));if(SB_CONFIGURED&&user?.id)await supabase.from("user_memberships").delete().eq("user_id",user.id).eq("provider",provider).eq("tier",tier);},[user?.id,previewMode]);
  const handleLogout=async()=>{if(SB_CONFIGURED)await supabase.auth.signOut();setUser(null);setActiveMemberships([]);setUsedMap({});setDismissedMap({});setTab("home");setPreviewMode(false);};

  const enterPreview=()=>{setPreviewMode(true);setShowSignInCallout(false);setTab("memberships");};
  const goToAuth=()=>{setPreviewMode(false);setShowSignInCallout(false);};
  ...
  if(!user&&!previewMode){
    if(!showSignInCallout){return(<div style={{maxWidth:420,margin:"0 auto",minHeight:"100vh",background:T.bg,position:"relative",fontFamily:"'DM Sans',sans-serif"}}><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet"/><AuthScreen onAuth={u=>{setUser(u);setPreviewMode(false);setShowSignInCallout(false);}}/><SignInCallout onSignIn={()=>setShowSignInCallout(true)} onDismiss={enterPreview}/></div>);}
    return<AuthScreen onAuth={u=>{setUser(u);setPreviewMode(false);}}/>;
  }

  const previewPerks=previewMode?allPerks.map(p=>({...p,used:false,dismissed:false})):userPerks;
  const previewMemberships=previewMode?[{provider:"OVO Energy",membership:"OVO Energy",tier:"Beyond"},{provider:"Monzo",membership:"Monzo",tier:"Max"},{provider:"Revolut",membership:"Revolut",tier:"Metal"},{provider:"American Express",membership:"American Express",tier:"Platinum"}]:displayMemberships;
  const countable=previewMode?previewPerks:userPerks.filter(p=>!p.dismissed);const usedCount=previewMode?0:countable.filter(p=>p.used).length;

  return(<div style={{maxWidth:420,margin:"0 auto",minHeight:"100vh",background:T.bg,color:T.textPrimary,position:"relative",fontFamily:"'DM Sans',sans-serif",display:"flex",flexDirection:"column"}}>
    ...
    {previewMode&&(<div style={{background:"linear-gradient(135deg,#1E293B,#0F172A)",padding:"8px 16px",fontSize:12,color:"#CBD5E1",fontWeight:600,textAlign:"center",fontFamily:"'DM Sans',sans-serif",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><span>👀 Preview Mode</span><span style={{color:"#64748B"}}>·</span><button onClick={goToAuth} style={{background:T.accent,border:"none",color:"#fff",fontSize:11,fontWeight:700,padding:"3px 10px",borderRadius:6,cursor:"pointer",fontFamily:"'DM Sans',sans-serif"}}>Sign In</button></div>)}
    <div style={{padding:"13px 18px 11px",background:"rgba(255,255,255,0.92)",backdropFilter:"blur(12px)",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:50}}>
      ...
      <div style={{fontSize:11,color:T.textSecondary,fontWeight:600,background:"#F1F5F9",padding:"3px 10px",borderRadius:20}}>{previewMode?"Preview":`Used ${usedCount} / Total ${countable.length}`}</div>
    </div>
    <div style={{flex:1,padding:"12px 16px 100px",overflowY:"auto"}}>
      {tab==="home"&&<HomeTab perks={previewPerks} onToggle={toggleUsed} onDismiss={toggleDismissed} previewMode={previewMode} onSignIn={goToAuth}/>}
      {tab==="memberships"&&<MembershipsTab perks={previewPerks} onToggle={toggleUsed} onDismiss={toggleDismissed} activeMemberships={previewMemberships} previewMode={previewMode} onSignIn={goToAuth}/>}
      {tab==="where"&&<WhereTab perks={previewPerks} onToggle={toggleUsed} onDismiss={toggleDismissed} previewMode={previewMode}/>}
      {tab==="potential"&&<PotentialTab allPerks={allPerks} activeMemberships={previewMode?previewMemberships:activeMemberships} onAddMembership={addMembership} userName={user?.name||""} userId={user?.id} previewMode={previewMode}/>}
      {tab==="profile"&&<ProfileTab perks={previewPerks} activeMemberships={previewMemberships} onRemoveMembership={removeMembership} user={user||{name:"Guest",email:"preview@perki.app"}} onLogout={handleLogout} onToggle={toggleUsed} onDismiss={toggleDismissed} previewMode={previewMode} onSignIn={goToAuth}/>}
    </div>
