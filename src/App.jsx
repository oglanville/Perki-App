...
/* ── Perk call-out modal (like How to Use overlay) ── */
function PerkCalloutModal({perk,onToggle,onDismiss,onClose}){
  const pCfg=PROVIDERS[perk.provider]||{color:T.accent};
  const b=PERK_BRANDS[perk.perk_id]||{emoji:"📦",gradient:`linear-gradient(135deg,${T.muted},${T.border})`};
  return(
